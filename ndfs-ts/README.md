...
- SINTRAN initial-command buffer: read / write / repair (`readInitialCommands`, `writeInitialCommands`, `repairInitialCommands`; see [../docs/SINTRAN-INITIAL-COMMANDS-SPEC.md](../docs/SINTRAN-INITIAL-COMMANDS-SPEC.md))

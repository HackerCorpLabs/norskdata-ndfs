...
- SINTRAN initial-command buffer: read / write / repair (`read_initial_commands`, `write_initial_commands`, `repair_initial_commands`; see [../docs/SINTRAN-INITIAL-COMMANDS-SPEC.md](../docs/SINTRAN-INITIAL-COMMANDS-SPEC.md))
